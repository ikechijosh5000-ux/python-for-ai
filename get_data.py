...
url = f"https://api.open-meteo.com/v1/forecast?latitude=34.6&longitude=4.54&start_date={start_date}&end_date={end_date}&daily=temperature_2m_max,temperature_2m_min"
